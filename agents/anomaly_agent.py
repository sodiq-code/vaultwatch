                ...
                if is_auth_error:
                    ...
                    if metrics.get("liquidity_ratio", 0.5) < 0.5:
                        anomalies_list.append(
                            {"metric": "Liquidity Depth", "value": metrics.get("liquidity_ratio", 0.5), "threshold": 0.5, "severity": "CRITICAL"}
                        )
                    ...
                    return AnomalyResult(
                        ...
                        recommendation=(
                            f"VaultWatch heuristic analysis (Groq unavailable): "
                            f"Risk score {score:.1f}/100. Severity: {severity}. "
