...
CONTRACTS = [
    ...
    {
        "name": "RiskOracle",
        "wasm": "target/wasm32-unknown-unknown/release/risk_oracle.wasm",
    ...
    {
        "name": "SentinelCredit",
        "wasm": "target/wasm32-unknown-unknown/release/sentinel_credit.wasm",
    ...
    },
    {
        ...
        "wasm": "target/wasm32-unknown-unknown/release/sentinel_alert_log.wasm",
    ...
    },
    {
        ...
        "wasm": "target/wasm32-unknown-unknown/release/agent_behavior_index.wasm",
    ...
    },
    {
        ...
        "wasm": "target/wasm32-unknown-unknown/release/risk_policy_manager.wasm",
    ...
    },
    {
        ...
        "wasm": "target/wasm32-unknown-unknown/release/subscriber_vault.wasm",
...
def main() -> None:
    ...
    logger.info("Node: %s | Mock: %s | Chain: %s", client.node_url, client.mock, client.chain_name)
