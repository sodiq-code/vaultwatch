...
INTERACTIONS = [
    ...
    ("AgentBehaviorIndex", "record_action", [
    ...
    ("RiskPolicyManager", "set_threshold", [
    ...
    ("SentinelRegistry", "register_sentinel", [
    ...
    ("SentinelCredit", "issue_credit", [
        DeployArgument("recipient", CLV_String("0202c27a6d17a12aef3775e27ac8964b075f55b665240f48d8d0880efdce56ea2116")),
        DeployArgument("amount",    CLV_U64(100)),
    ]),
    # SubscriberVault — 2 calls
    ("SubscriberVault", "subscribe", [
